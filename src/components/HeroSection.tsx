...
const HeroSection = () => {
  ...
  const welcomeText = useMemo(() => {
    return session?.user?.name ? `Welcome, ${session.user.name}!` : "";
  }, [session?.user?.name]);
    ...
    <section className="relative w-full py-12 md:py-20 px-6 md:px-12 flex flex-col items-center justify-center overflow-hidden bg-background">
      ...
      >
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-medium tracking-tighter text-balance text-foreground">
          ...
          <span className="text-foreground">listening history</span>
        </h1>
        ...
        <div className="flex flex-col items-center gap-3 sm:gap-6 pt-0">
          ...
          <Button className="bg-primary text-primary-foreground hover:bg-primary/80 hover:text-primary-foreground text-base h-12 px-8 transition-all duration-200 min-h-[48px] outline-1 outline-offset-1 outline-solid">
            Start discovering
          </Button>
        </div>
