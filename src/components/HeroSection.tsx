...
import { Loader, Plus, ExternalLink, Play, Heart, MoreHorizontal } from 'lucide-react';
...
const MusicBoard = () => {
  const columns = [
    {
      ...
      items: [
        { id: 1, title: 'Midnight City', artist: 'M83', genre: 'Electronic', match: '95%', image: '🎵' },
        { id: 2, title: 'Strobe', artist: 'Deadmau5', genre: 'Electronic', match: '92%', image: '🎶' },
        { id: 3, title: 'Bohemian Rhapsody', artist: 'Queen', genre: 'Rock', match: '89%', image: '🎤' }
      ]
    },
    {
      id: 'liked',
      ...
      color: 'bg-green-500',
      items: [
        { id: 4, title: 'Teardrop', artist: 'Massive Attack', genre: 'Trip Hop', match: '97%', image: '💧' },
        { id: 5, title: 'Porcelain', artist: 'Moby', genre: 'Electronic', match: '94%', image: '🏺' }
      ]
    },
    {
      id: 'queue',
      ...
      color: 'bg-orange-500',
      items: [
        { id: 6, title: 'Time', artist: 'Pink Floyd', genre: 'Progressive Rock', match: '91%', image: '⏰' },
        { id: 7, title: 'Claire de Lune', artist: 'Debussy', genre: 'Classical', match: '88%', image: '🌙' },
        { id: 8, title: 'Take Five', artist: 'Dave Brubeck', genre: 'Jazz', match: '85%', image: '🎺' }
      ]
    }
  ];
  ...
  const MusicCard: React.FC<MusicCardProps> = ({ item, isDragging = false }) => (
    <div className={`group bg-white rounded-lg p-4 border border-gray-200 shadow-sm hover:shadow-md transition-all cursor-pointer ${isDragging ? 'opacity-50 rotate-2' : ''}`}>
    ...
    <section className="relative w-full py-12 md:py-20 px-6 md:px-12 flex flex-col items-center justify-center overflow-hidden bg-gray-50">
      ...
      <div className={`relative z-10 max-w-4xl text-center space-y-6 transition-all duration-700 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-medium tracking-tight text-balance text-gray-900">
          Discover new music based on your <span className="text-gray-900">listening history</span>
        </h1>
        
        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto text-balance">
          Uncover your next favorite songs with AI-powered recommendations that learn from your unique music taste and listening patterns.
        </p>
          ...
          <div className="bg-white/90 backdrop-blur-md w-full">
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-900 font-medium">Music Discovery Dashboard</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="flex -space-x-2">
                  ...
                  <div className="h-8 w-8 rounded-full bg-gray-500 border-2 border-white flex items-center justify-center text-xs text-white">+3</div>
                </div>
            ...
            <div className="flex h-[600px] overflow-hidden">
              ...
              <div className="w-64 border-r border-gray-200 p-4 space-y-4 hidden md:block bg-gray-50/50">
                <div className="space-y-2">
                  <div className="text-xs text-gray-500 uppercase font-medium">Navigation</div>
                ...
                <div className="space-y-2 pt-4">
                  <div className="text-xs text-gray-500 uppercase font-medium">Genres</div>
                  <div className="space-y-1">
                    <div className="flex items-center gap-3 px-3 py-2 rounded-md text-gray-600 hover:bg-gray-100 cursor-pointer">
              ...
              <div className="flex-1 p-4 bg-gray-50/30 overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <span className="text-xs bg-gray-100 px-2 py-1 rounded-full text-gray-600">42</span>
                  </div>
