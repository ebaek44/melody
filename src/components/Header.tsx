...
import { Menu, X, Music2, BarChart3, Crown, Sun, Moon } from 'lucide-react';
        ...
        <nav className="hidden md:flex items-center absolute left-1/2 transform -translate-x-1/2">
          <div className="rounded-full px-1 py-1 backdrop-blur-md bg-background/80 border border-border shadow-lg">
            <ToggleGroup type="single" value={activePage} onValueChange={(value: React.SetStateAction<string>) => value && setActivePage(value)}>
              ...
              >
                <Music2 size={16} className="inline-block mr-1.5" /> Features
              </ToggleGroupItem>
              <ToggleGroupItem 
                value="dashboard" 
                className={cn(
              ...
              >
                <BarChart3 size={16} className="inline-block mr-1.5" /> Discovery
              </ToggleGroupItem>
              <ToggleGroupItem 
                value="pricing" 
                className={cn(
